...
private:
    ...
    static bool contour_compare_area(const std::vector<cv::Point> c1, const std::vector<cv::Point> c2);
    static bool compare_points(const cv::Point& p1, const cv::Point& p2);
};
